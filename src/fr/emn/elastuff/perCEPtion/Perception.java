	...
	private void parse(String line){
		...
		if(commandTokenizer.hasMoreTokens()){
			...
			if(command.equals(Perception.commandSimulate)){
				...
				if(!commandTokenizer.hasMoreTokens()){
					System.out.println("ERROR : the command " + Perception.commandSimulate + " need an argument <cloudRessource>");
					System.out.println(Perception.needHelp);
					return;
				}
				...
				if(!commandTokenizer.hasMoreTokens()){
					System.out.println("ERROR : the command " + Perception.commandSimulate + " need an argument <component>");
					System.out.println(Perception.needHelp);
					return;
				}
				...
				if(!commandTokenizer.hasMoreTokens()){
					System.out.println("ERROR : the command " + Perception.commandSimulate + " need an argument <value>");
					System.out.println(Perception.needHelp);
					return;
				}
				...
				try{
					...
					System.out.println("ERROR : the <value> of the command "+Perception.commandSimulate+" must be an integer");
					return;
				}
				...
				try {
					...
					System.out.println("PERCEPTION : value "+value+" setted in " +compo + " on " +cr);

...
public class Test {
	...
	public static void main(String[] args) {
		...
		//offering infra
		OffInfra small = new OffInfra("small",1, 1024, 10);     // 1CPU , 512 MB , 10 GB
		OffInfra medium = new OffInfra("medium",2, 2048, 50); // 2 CPU , 2048 MB , 50 GB
		OffInfra large = new OffInfra("large",4, 4096, 500);   // 4 CPU , 4096 MB , 500 GB
		...
		/*
		 * //initialize OfferingsSoftDB 
		 * OfferingsSoftDB offeringsSoft =

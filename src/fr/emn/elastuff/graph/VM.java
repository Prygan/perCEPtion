...
public class VM extends CloudResource {
	...
	public void display() {
		...
		for (int i = 0; i < cos.size(); i++) {
			...
			System.out.println("		| " + name + " , " + cos.get(i).getTypeCO()
					+ " , " + cos.get(i).getOfferingCO().getName());
		}
	...
	/******************************************** Actions ********************************************/
					...
					/************************ Scale Up Infra ************************
					 * 				increase the offering of this VM
					 ****************************************************************/
	...
	public void sui() throws UnsupportedOperationException {
		...
		/*OfferingVM offeringVM = this.getOfferingVM();
		switch (offeringVM) {

		case LARGE:
			throw new UnsupportedOperationException("Invalide operation : Offering of " + this.getName() + " = LARGE");

		case MEDIUM:
			this.setOfferingVM(OfferingVM.LARGE);
			break;
		case SMALL:
			this.setOfferingVM(OfferingVM.MEDIUM);
			break;
		default:
			break;*/
					...
					/************************ Scale Down Infra ************************
					 * 				decrease the offering of this VM
					 ******************************************************************/
	...
	public void sdi() throws UnsupportedOperationException {
		...
		case LARGE:
			...
			break;
		case MEDIUM:
			this.setOfferingVM(OfferingVM.SMALL);
			break;

		case SMALL:
			throw new UnsupportedOperationException("Invalide operation : Offering of " + this.getName() + " = SMALL");
		...
		default:
			break;
					...
					/************************ Scale Out Soft ************************
					 * 		add (nbCo) CO with type (typeCO) for this VM
					 ****************************************************************/
	...
	public void sos(int nbCO, String typeCO) {
		...
		for (int i = 1; i <= nbCO; i++) {
			...
			j++;
					...
					/************************ Scale In Soft ************************
					 * 	remove (nbCo) CO with type (typeCO) from this VM
					 ***************************************************************/
	...
	public void sis(int nbCO, String typeCO) throws UnsupportedOperationException {
		...
		if (this.getCos().size() >= nbCO) {
			...
			throw new UnsupportedOperationException("Invalid operation ");
					...
					/************************ Scale In Soft ************************
					 * 				remove (co) from this from this VM
					 ***************************************************************/
	...
	public void sis(Co co) throws UnsupportedOperationException {
		...
		try {
			...
			e.printStackTrace();
					...
					/************************ Scale Up Soft ************************
					 * 			increase the offering of each CO in this VM
					 ***************************************************************/

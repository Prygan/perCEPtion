...
public class Tier extends CloudResource {
	...
	void removeElt(CloudResource o) throws UnsupportedOperationException {
		...
		else throw new UnsupportedOperationException("Not found");
	}
	...
	public void display() {
		...
		/*	System.out.println("	| " + name + " , " + vms.get(i).getOfferingVM());
			vms.get(i).display();*/
			//new
	...
	/************************ Scale Out Infra ************************
	 *   add (nbVM) VM with offering (OfferingVM) for this tier
	 *****************************************************************/
	@Override
	...
	/************************ Scale Out Infra ************************
	 *   add 1 VM with offering (OfferingVM) for this tier
	 *****************************************************************/
	@Override
	public void soi( OffInfra offering) {
		...
		this.soi(1,offering);
			/*VM vm = new VM("VM" + hashCode(), offering);
			this.addElt(vm);*/
	...
	/************************ Scale Out Infra ************************
	 *   add  VMs with offering (OfferingVM) for this tier
	 *****************************************************************/
	/*@Override
	public void soi() {
		System.out.println(this.getName()+".soi");
		...
		for (int i = 1; i <= nb; i++) {
			...
			VM vm = new VM("VM" + hashCode() + j,OfferingVM.SMALL);
			this.addElt(vm);
			j++;
		}
	}*/
	...
	public void sii(int nbResources) throws SizeLimitExceededException {
		...
		if (this.getVms().size() >= nbResources) {
			...
			throw new SizeLimitExceededException(
					"exceeded the limit : " + this.getName() + " has only " 
			+ this.getVms().size() + " VM(s)");

	}

	/************************Scale In Infra ************************ 
	 * 					remove (vm) from this Tier
	 ***************************************************************/
	...
	/************************ Scale Up Infra ************************
	 * 				increase the offering of each VM of this tier
	...
	/************************ Scale Down Infra ************************
	 * 				decrease the offering of each VM of this tier
	 * 						 Large  --> Medium
	 * 						 Medium --> Small
	...
	/************************ Scale Out Soft ************************
	 * 		add (nbCo) CO with type (typeCO) for each VM of this tier
	 ****************************************************************/
	@Override
	...
	/************************ Scale In Soft ************************
	 * 	remove (nbCo) CO with type (typeCO) of each VM of this tier
	 ***************************************************************/
	@Override
	...
	/************************ Scale Up Soft ************************
	 * 	increase the offering of each CO of all vms of this tier
	 * 						 Mode1 --> Mode2
	 * 						 Mode2 --> Mode3
